import { hsvaToRgba, rgbaToHex, rgbaToHsva, withAlpha, type Hsva, type RGBA } from '@starforge/core'
...
export function ColorField({
    ...
    const opaque = rgbaToHex(withAlpha(value, 255))
                ...
                {CHANNELS.map((channel) => (
                    <label key={channel.key} class={styles.channel}>
                        ...
                        <input
                            ...
                            min={0}
                            max={255}
                            value={(value >>> channel.shift) & 0xff}
                            ...
                            onInput={(e) => {
                                ...
                                setColor(((value & mask) | (next << channel.shift)) >>> 0)
                            }}
                        />
                    </label>
                ))}
...
export function parseHexField(value: string): RGBA | null {
